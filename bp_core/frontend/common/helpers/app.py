...
class App:
    ...
    def get_contexts(self, **kwargs):
        return self.driver.contexts

    def get_current_context(self):
        return self.driver.current_context

    def switch_context(self, name, **kwargs):
    ...
    def swipe_left_by_coordinates(self, pixels):
        start_x = 800
        start_y = 700
    ...
    def swipe_right_by_coordinates(self, pixels):
        start_x = 100
        start_y = 700
        end_x = start_x + pixels
        end_y = 700
    ...
    def swipe_down(self, percent, number):
        ...
        for attempt in range(int(number)):
