...
from bp_core.utils.utils import remove_chars_from_string
                ...
                for scenario_run in scenarios_run[tr_run.name]:
                    ...
                    tr_test = next(
                        (
                            ...
                            if (test.title == scenario_run.name
                                and test.custom_methods["custom_data_set"] is None) or
                               (scenario_run.name + " -> " +
                    ...
                    if tr_test is None:
                        ...
                        if scenario_run.failed:
                            if scenario_run.data_set:
                                test_name = "test_" + scenario_run.name.replace(' ',"_").lower() + "[" + ''.join(scenario_run.data_set.values()) + "]"
                            else:
